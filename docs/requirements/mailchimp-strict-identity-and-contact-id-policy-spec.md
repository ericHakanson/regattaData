...
### 12.2 Ingestion Logic (`mailchimp_audience`)
...
### 12.3 Activation Logic (`mailchimp_event_activation`)
...
### 12.4 Counters and Reporting

- [ ] Add required counters from Section 9 to shared run counters.
